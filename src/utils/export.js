...
export const buildMPOHTML = (mpo) => {
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .cal-wrap{overflow-x:auto;overflow-y:hidden;margin-bottom:8px;scrollbar-width:none;-ms-overflow-style:none}.cal-wrap::-webkit-scrollbar{display:none;width:0;height:0;background:transparent}
